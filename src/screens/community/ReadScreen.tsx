...
type Props = CommunityStackScreenProps<"CommunityRead">;

const ReadScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container} edges={safeAreaEdges}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.body}>Coming soon — add reading list, articles or guides.</Text>
      </View>
    </SafeAreaView>
  );
};
